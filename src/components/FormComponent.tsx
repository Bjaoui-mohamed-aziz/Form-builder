...
type FormComponentProps = {
  ...
  name: string;
  type: string;
  onDelete: (id: string) => void; // Add a delete handler function
...
const FormComponent: React.FC<FormComponentProps> = ({id, name, type, onDelete }) => {
  ...
  return (
    <div className="w-60 h-48  flex flex-col m-4 border-2 border-gray-300 p-4 mb-4 shadow-lg rounded-lg bg-white relative hover:bg-gray-100 hover:shadow-2xl transition duration-300">
